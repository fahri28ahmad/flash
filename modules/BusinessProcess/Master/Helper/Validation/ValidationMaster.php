...
namespace BusinessProcessRoot\Master\Helper\Validation;

use \Config\Services as SVC;
use BusinessProcessRoot\Master\Entities\Response\Helper\ValidateResponse;
use \Datetime;
...
trait ValidationMaster{
	...
	public function none($field,$val){
		$data_send = array();
		$data_send['error'] = 0;
		$data_send['value'] = $val;
		$data_send['error_message'] = "";
